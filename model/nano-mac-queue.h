...
#ifndef NANO_MAC_QUEUE_H
#define NANO_MAC_QUEUE_H
 ...
 *
 */
class NanoMacQueue : public Object
{
public:
...
private:
   ...
   */
  NanoMacQueue::QueueElement Front () const;
...
public:
   ...
   */
  const NanoMacQueue::PacketQueue & GetPacketQueue (void) const;
};

} // namespace ns3

#endif /* NANO_MAC_QUEUE_H */
